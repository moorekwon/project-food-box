# Generated by Django 3.0.6 on 2020-05-28 16:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('육수', '육수'), ('채소', '채소'), ('해산물', '해산물'), ('고기/계란', '고기/계란'), ('밥/쌀', '밥/쌀'), ('김치/발효', '김치/발효'), ('간식/디저트', '간식/디저트')], max_length=30)),
        ...
        migrations.AddField(
            ...
            name='food',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main.RecommendedFood'),
        ),
    ]
